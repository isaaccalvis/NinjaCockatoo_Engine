...
public:
	...
	PhysBody3D* AddBody(const Sphere& sphere, float mass = 1.0f, bool render_primtive = false);
	PhysBody3D* AddBody(const Cube& cube, float mass = 1.0f, bool render_primtive = false);
